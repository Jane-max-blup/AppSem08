...
<div class="container-fluid">
    ...
    <a class="navbar-brand" href="pais.php">País</a>
        ...
        <div id="form">
          <form  method="post">
              ...
              <table width="100%" border="1" cellpadding="15">
                  ...
                  <tr>
                      <td>
                          <label for="nom_pais">Ingrese el nombre del país</label><br><br>
                          <input type="text" name="nom_pais" placeholder="ejemplo: Perú" value="<?php
          ...
          <br><br>
          <h3>Listado de paises agregados</h3>
          <br>
            ...
            <thead>
              ...
              ?>
                <tr>
                    ...
                    <td><a href="?edit=<?php echo $row['idPais']?>" onclick="return confirm('Confirmar edición')">Editar</a></td>
                    <td><a href="?del=<?php echo $row['idPais']?>" onclick="return confirm('Confirmar eliminación')">Eliminar</a></td>
